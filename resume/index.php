...
<body>
	<div id="content">
		...
		<div id="right_col">
			...
			<?php } ?>
			<?php if (isset($settings['certificates']) && $settings['certificates'] == true) { ?>
			<div class="item">
				<span class="large_title"><?php echo $lang['certificates']; ?></span><br />
				<?php for($i=0; $i<count($certificates); $i++) { ?>
				<p><span class="title"><?php echo $certificates[$i][0]; ?></span><br />
				<?php echo $certificates[$i][1]; ?></p>
				<?php } ?>
			</div>
			<?php } ?>
			<?php if (isset($settings['languages']) && $settings['languages'] == true) { ?>
			<div class="item">
				<span class="large_title"><?php echo $lang['languages']; ?></span><br />
				<?php for($i=0; $i<count($languages); $i++) { ?>
				<p><span class="title"><?php echo $languages[$i][0] ?></span><br />
				<?php echo $languages[$i][1]; ?></p>
				<?php } ?>
			</div>
			<?php } ?>
		</div>
		<div id="footer">
			...
			<li><a href="http://www.ioanpetras.com/files/resume.pdf">.PDF</a></li>
			<li><a href="http://www.ioanpetras.com/files/resume.docx">.DOC</a></li>
			</dl>
		</div>
	</div>
</body>
